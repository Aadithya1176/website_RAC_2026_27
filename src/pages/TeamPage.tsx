...
const TeamPage = () => {
  ...
  const coreLeadership = [
    ...
    { name: 'Rtr. Nikhilesh Anand', title: 'Sergeant-At-Arms 26-27', image: '/board/Nikhilesh Anand (Sergeant-At-Arms).png' },
    { name: 'Rtr. Nila Elango', title: 'Deputy Sergeant-At-Arms 26-27', image: '/board/Nila Elango.jpg' },
    { name: 'Rtr. Akshith R', title: 'Treasurer 26-27', image: '/board/Akshith R.jpg' },
