...
const TeamPage = () => {
  ...
  const boardCoordinators: typeof coreLeadership = [
    ...
    { name: 'Charunetra R', title: 'Club Coordinator 26-27', image: '' },
    ...
    { name: 'Harileena S', title: 'Club Coordinator 26-27', image: '' },
    ...
    { name: 'Lingeesh L', title: 'Club Coordinator 26-27', image: '' },
    ...
    { name: 'Sandhiya E', title: 'Club Coordinator 26-27', image: '' },
    ...
    { name: 'Tarika R', title: 'Club Coordinator 26-27', image: '' },
